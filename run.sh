...
generate_secrets() {
    ...
    update_env_var "$env_file" "DOPLARR_TOKEN" "PLACEHOLDER_SET_IN_GITHUB_SECRETS"
    ...
    log WARN "  SONARR_API_KEY, RADARR_API_KEY, LIDARR_API_KEY, DOPLARR_TOKEN"
}
...
# =============================================================================
# Doplarr (Discord Bot - Injected from GitHub Secrets)
# =============================================================================
DOPLARR_TOKEN=PLACEHOLDER_SET_IN_GITHUB_SECRETS
DOPLARR_MAX_RESULTS=25
DOPLARR_MSG_STYLE=:plain
